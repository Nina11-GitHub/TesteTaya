...
public class emprestimoComGarantiaImovelPJuridicaComercial extends Driver {
	...
	@Test
	public void emprestimoComGarantiaImovelPJuridicaPositivo() throws InterruptedException {
		Thread.sleep(5000);
		metodos.clicar(el.aquisicaoDeImovel);
		metodos.aguardarElemento(el.PJuridica, 10);
		metodos.clicar(el.PJuridica);
		...
		metodos.capturarScreenshot("GarantiaImovel", "EmprestimoPJ");
	}
